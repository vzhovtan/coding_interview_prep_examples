...
def findAllReportingEmployees(manager, managerToEmployeeMappings, result):
    ...
    if managerEmployees:
        ...
        for reportee in managerEmployees.copy():
            ...
            employees = findAllReportingEmployees(reportee, managerToEmployeeMappings, result)
...
def findEmployees(employeeToManagerMappings):
    ...
    # store manager to employee mappings in a dict is used since a manager can have several employees mapped
    ...
    # find all reporting employees (direct and indirect) for every manager and store the result in a dict
...
# driver code
employeeToManagerMappings = {'A': 'A', 'B': 'A', 'C': 'B', 'D': 'B', 'E': 'D', 'F': 'E'}
